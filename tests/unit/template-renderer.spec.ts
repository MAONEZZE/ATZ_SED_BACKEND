...
describe('TemplateRenderer', () => {
  ...
  describe('render', () => {
    ...
    it('replaces multiple different variables', () => {
      expect(renderer.render('{{nome}} foi para {{evento}}', { nome: 'Maria', evento: 'Tech Day' })).toBe('Maria foi para Tech Day');
    });
  ...
  describe('buildVariables', () => {
    ...
    const event = { title: 'Tech Day', eventDate: new Date('2026-06-15T18:00:00'), location: 'SP', capacity: 100, dressCode: 'Smart', groupLink: 'https://wa.me/group' };
    ...
    it('maps empty string when eventDate is null', () => {
      const vars = renderer.buildVariables({ registration: reg, event: { ...event, eventDate: null } });
